...
//					cap.setCapability("appActivity", "com.google.android.apps.chrome.Main");  
	...
	public void toBack(AppiumDriver driver) {
		...
		swipe.addAction(finger.createPointerDown(PointerInput.MouseButton.BACK.asArg()));
		swipe.addAction(finger.createPointerMove(Duration.ofMillis(1000), PointerInput.Origin.viewport(), 500, 500)); 
		swipe.addAction(finger.createPointerUp(PointerInput.MouseButton.BACK.asArg()));
